...
// Usage: <Icon name="dashboard" className="h-4 w-4" />
...
const paths = {
  ...
  vault: (
    <>
      ...
      <path d="M13 8.5v1M13 14.5v1M9.5 12h-1M16.5 12h1" />
    </>
  ),
  send: <path d="m4 12 16-8-6 16-3-7-7-1z" />,
  command: (
  ...
  phone: (
    <path d="M22 16.92V21a1 1 0 0 1-1.1 1A19 19 0 0 1 2 4.1 1 1 0 0 1 3 3h4.1a1 1 0 0 1 1 .75l1 4a1 1 0 0 1-.27 1L7 10.5a16 16 0 0 0 6.5 6.5l1.7-1.85a1 1 0 0 1 1-.27l4 1a1 1 0 0 1 .8 1.04z" />
  ),
  mail: (
    <>
  ...
  tiktok: (
    <path d="M14 3v9.5a3.5 3.5 0 1 1-3.5-3.5H12V6.5a6.5 6.5 0 1 0 6.5 6.5V8.2a6.5 6.5 0 0 1-3.5-1V3z" />
  ),
  facebook: <path d="M13 22V12h3l1-4h-4V5.5c0-1 .3-1.5 1.5-1.5H17V0h-3c-3 0-4 1.8-4 4.5V8H7v4h3v10z" />,
  message: (
